<div>
    ...
    <div class="mb-6">
        <a href="{{ route('meal-plans.create') }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-zinc-800 text-gray-900 dark:text-white font-semibold rounded-lg border border-gray-300 dark:border-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-700 transition">
    ...
    @if($mealPlans->isEmpty())
        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow p-6">
            <div class="text-center py-12">
                ...
                <a href="{{ route('meal-plans.create') }}" class="inline-block mt-4 px-4 py-2 bg-white dark:bg-zinc-800 text-gray-900 dark:text-white font-semibold rounded-lg border border-gray-300 dark:border-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-700 transition">
                    Create Meal Plan
                </a>
            </div>
        </div>
