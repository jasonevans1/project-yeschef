<div>
    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
        @if($existingList)
            ...
            <div class="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <flux:heading size="md" class="text-yellow-800 mb-1">List Already Exists</flux:heading>
                        <flux:text class="text-yellow-700 text-sm">
                ...
                @else
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <flux:text class="text-amber-800 font-medium">No recipes assigned</flux:text>
        ...
        {{-- Loading State --}}
        <div wire:loading wire:target="generate" class="mt-4 flex items-center justify-center gap-2 text-blue-600">
