...
<flux:modal wire:model="showShareDialog" class="max-w-md">
    ...
    @if($groceryList->is_shared)
        <div class="space-y-4" x-data="{ copied: false }">
            <div>
                <flux:text class="text-sm font-medium text-gray-700 dark:text-zinc-300 mb-2">Shareable Link</flux:text>
                <div class="flex items-center gap-2">
                    <input
                        type="text"
                        readonly
                        value="{{ $groceryList->share_url }}"
                        class="flex-1 px-3 py-2 text-sm border border-gray-300 dark:border-zinc-600 rounded-lg bg-gray-50 dark:bg-zinc-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-text select-all"
                        id="shareLink"
                        x-ref="shareLink"
            ...
            @if($groceryList->share_expires_at)
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            <flux:text class="text-sm font-medium text-blue-900 dark:text-blue-100">Link Expiration</flux:text>
            ...
            <div class="bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-600 rounded-lg p-3">
                <div class="flex items-start gap-2">
                    <svg class="w-5 h-5 text-gray-600 dark:text-zinc-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-4">
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <flux:text class="text-sm font-medium text-blue-900 dark:text-blue-100 mb-1">Share Your List</flux:text>
